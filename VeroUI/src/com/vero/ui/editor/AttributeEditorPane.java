...
public class AttributeEditorPane extends EditorPane<AttributeObjectData> {
	...
	try {
	    ...
	    // 4. If formula is changed and formula already exists in current attribute/metric, go to next step.
	    ...
	    // 5. If formula is changed and formula doesn't exist in current attribute/metric.
